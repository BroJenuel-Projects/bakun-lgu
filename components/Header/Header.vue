        ...
        <div class="max-w-full mx-auto px-4 sm:px-6">
            ...
            >
                ...
                <nav class="hidden md:flex space-x-10">
                    <div class="relative hover-trigger-dropdown">
          ...
          -->
                        <div
                            class="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2 hover-trigger-show"
                        >
                            <div
          ...
          -->
                        <div
                            class="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0 hover-trigger-show"
                        >
                            <div
                                class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden"
                            >
